  ...
  return (
    ...
    >
      <motion.span
        ...
        transition={transition}
        className={cn(DEFAULT_SPAN_CLASS_NAME, "bg-muted text-foreground", frontClassName)}
      >
        {frontDisplay}
      </motion.span>
      <motion.span
        ...
        transition={transition}
        className={cn(DEFAULT_SPAN_CLASS_NAME, "bg-destructive text-destructive-foreground", backClassName)}
      >
        {backDisplay}
      </motion.span>

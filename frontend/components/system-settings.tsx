          ...
          <TabsList className="grid w-full grid-cols-3">
            <TabsTrigger value="chat">
              <span className="flex items-center gap-2">
                <span className={`w-2 h-2 rounded-full ${chatConfig.enabled ? "bg-green-500" : "bg-gray-400"}`}></span>
                通用大模型
              </span>
            </TabsTrigger>
            <TabsTrigger value="embedding">
              <span className="flex items-center gap-2">
                <span className={`w-2 h-2 rounded-full ${embeddingConfig.enabled ? "bg-green-500" : "bg-gray-400"}`}></span>
                向量模型
              </span>
            </TabsTrigger>
            <TabsTrigger value="rerank">
              <span className="flex items-center gap-2">
                <span className={`w-2 h-2 rounded-full ${rerankConfig.enabled ? "bg-green-500" : "bg-gray-400"}`}></span>
                重排模型
              </span>
            </TabsTrigger>
          </TabsList>
